...
<html>
	...
	<head>
		...
		<link href="${env.resourcesUrl}/css/bootstrap.min.css" rel="stylesheet">

		<!-- Custom CSS -->
		<link href="${env.resourcesUrl}/css/freelancer.css" rel="stylesheet">

		<!-- Custom Fonts -->
		<link href="${env.resourcesUrl}/font-awesome-4.1.0/css/font-awesome.min.css"
	...
	<body id="page-top" class="index">
		...
		<header>
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<img class="img-responsive" src="${env.resourcesUrl}/img/profile.png" alt="">
				...
				<div class="row">
					<div class="col-sm-4 portfolio-item">
						<a href="#portfolioModal1" class="portfolio-link"
							...
							</div> <img src="${env.resourcesUrl}/img/portfolio/cabin.png" class="img-responsive" alt="">
						</a>
					</div>
					<div class="col-sm-4 portfolio-item">
						<a href="#portfolioModal2" class="portfolio-link"
							...
							</div> <img src="${env.resourcesUrl}/img/portfolio/cake.png" class="img-responsive" alt="">
						</a>
					</div>
					<div class="col-sm-4 portfolio-item">
						<a href="#portfolioModal3" class="portfolio-link"
							...
							</div> <img src="${env.resourcesUrl}/img/portfolio/circus.png" class="img-responsive"
								alt=""> </a>
					</div>
					<div class="col-sm-4 portfolio-item">
						<a href="#portfolioModal4" class="portfolio-link"
							...
							</div> <img src="${env.resourcesUrl}/img/portfolio/game.png" class="img-responsive" alt="">
						</a>
					</div>
					<div class="col-sm-4 portfolio-item">
						<a href="#portfolioModal5" class="portfolio-link"
							...
							</div> <img src="${env.resourcesUrl}/img/portfolio/safe.png" class="img-responsive" alt="">
						</a>
					</div>
					<div class="col-sm-4 portfolio-item">
						<a href="#portfolioModal6" class="portfolio-link"
							...
							</div> <img src="${env.resourcesUrl}/img/portfolio/submarine.png" class="img-responsive"
								alt=""> </a>
					</div>
				</div>
			</div>
