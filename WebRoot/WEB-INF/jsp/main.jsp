...
<html>
	...
	<head>
		...
		<!-- Custom CSS -->
		<link href="${env.resourcesUrl}/vlife/css/vlife.css" rel="stylesheet">
	...
	<body id="page-top" class="index">
				...
				<div class="row">
					<div class="col-lg-12">
						<p class="page-scroll">
							...
							<c:if test="${login}">
								<a href="#property" class="portfolio-link game-page"
									url="property" data-toggle="modal">
							</c:if>
							<img class="img-responsive"
								src="${env.resourcesUrl}/vlife/img/${profile}" alt="">
							</a>
						</p>
						<div class="intro-text">
							...
							<hr class="star-light">
							<span class="skills"> <c:if test="${login}">
									<div class="timer">
			...
			<section id="portfolio">
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-sm-4 portfolio-item">
							<a href="#action" class="portfolio-link game-page"
								url="${species.name}/action" data-toggle="modal">
								<div class="caption">
									<div class="caption-content">
										<i class="fa fa-search-plus fa-3x"></i>
									</div>
						...
						<div class="col-sm-4 portfolio-item">
							<a href="#inventory" class="portfolio-link game-page"
								url="inventory" data-toggle="modal">
								<div class="caption">
									<div class="caption-content">
										<i class="fa fa-search-plus fa-3x"></i>
									</div>
						...
						<div class="col-sm-4 portfolio-item">
							<a href="#portfolioModal6" class="portfolio-link"
								...
								<div class="caption">
									...
									src="${env.resourcesUrl}/vlife/img/portfolio/submarine.png"
									class="img-responsive" alt=""> </a>
						</div>
					</div>
				</div>
		...
		<div class="portfolio-modal modal fade" id="property" tabindex="-1"
			role="dialog" aria-hidden="true"></div>
		<div class="portfolio-modal modal fade" id="region" tabindex="-1"
			role="dialog" aria-hidden="true"></div>
		<div class="portfolio-modal modal fade" id="action" tabindex="-1"
			role="dialog" aria-hidden="true"></div>
		<div class="portfolio-modal modal fade" id="inventory" tabindex="-1"
			role="dialog" aria-hidden="true"></div>
