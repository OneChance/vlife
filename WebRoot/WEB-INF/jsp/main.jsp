		...
		<div class="container">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="page-scroll"><a href="#portfolio"><spring:message
								code="info" /> </a></li>

					<c:if test="${login}">
						<li><a id="unsign" style="cursor: pointer;"><spring:message
									code="unsign" /> </a></li>
					</c:if>
						...
						<form id="accountForm" novalidate>
							...
							<div class="row control-group">
								<div
									...
									<label> <spring:message code='account' />
									</label>
							...
							<div class="row control-group for-reg">
								<div class="col-xs-12 controls">
									<div style="margin-top: 30px; margin-bottom: 20px;">
										...
										<label for="sexm" class="radio-label"> <spring:message
												code='sexm' />
										</label> &nbsp;&nbsp;&nbsp;&nbsp;
										<input type="radio" id="sexf" name="sex" value="f">
										<label for="sexf" class="radio-label"> <spring:message
												code='sexf' />
										</label>
									</div>
									<p class="help-block text-danger"></p>
